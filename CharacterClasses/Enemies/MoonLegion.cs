...
{
    public class MoonLegion : BaseFighter
    {
        public MoonLegion()
        {
            Level = 7;
            ...
            Abilities = new List<Ability>() { new Launch(), new Lunge(), new ShadowSpear() };
            CharacterType = "Dark Legion";
        ...
        public MoonLegion(BaseFighter fighter) : base(fighter) { }

        public override BaseFighter Clone()
        {
            return new MoonLegion(this);
        }
