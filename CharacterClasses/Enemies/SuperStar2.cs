...
{
    public class SuperStar2 : BaseFighter
    {
        public SuperStar2()
        {
            Level = 7;
            ...
            PhysicalDefense = random.Next(30, 40);
            MagicAttack = random.Next(25, 35);
            MagicDefense = random.Next(25, 35);
            Speed = random.Next(25, 35);
            Abilities = new List<Ability>() { new Solo(), new Smash(), new RockOut() };
        ...
        public SuperStar2(BaseFighter fighter) : base(fighter) { }

        public override BaseFighter Clone()
        {
            return new SuperStar2(this);
        }
