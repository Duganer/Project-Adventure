...
{
    public class StarAstronomer : BaseFighter
    {
        public StarAstronomer()
        {
            Level = 7;
            ...
            Abilities = new List<Ability>() { new Meteor(), new SunRay(), new Starfall() };
            CharacterType = "Star Astronomer";
        ...
        public StarAstronomer(BaseFighter fighter) : base(fighter) { }

        public override BaseFighter Clone()
        {
            return new StarAstronomer(this);
        }
